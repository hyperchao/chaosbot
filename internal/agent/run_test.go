...
func TestRun_TwoStepReActLoop(t *testing.T) {
	...
	a := &agent.Agent{Provider: fp, Registry: reg, MaxSteps: 5}
	...
	// Second request: user + assistant(tool call) + tool(result) = 3.
...
func TestRun_MaxStepsReached(t *testing.T) {
	// Every step returns a tool call, never a final answer.
	...
	a := &agent.Agent{Provider: fp, Registry: reg, MaxSteps: 3}
...
func TestRun_ContextCanceled(t *testing.T) {
	...
	a := &agent.Agent{Provider: fp, Registry: agent.NewRegistry(), MaxSteps: 5}
